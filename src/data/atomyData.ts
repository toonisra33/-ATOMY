...
export const DEFAULT_SPONSOR: SponsorProfile = {
  ...
  customVideoUrl: 'https://youtu.be/xY6IqUkCljk?si=7iSGQSjsRbMVyN6O',
};
...
export const VIDEO_PRESETS: VideoPreset[] = [
  {
    ...
    youtubeId: 'xY6IqUkCljk', // https://youtu.be/xY6IqUkCljk?si=7iSGQSjsRbMVyN6O
...
export const VIDEO_CHAPTERS: VideoChapter[] = [
  {
    ...
    timeSeconds: 0,
    timestamp: '00:00',
    title: 'สิ่งที่น่าเสียดายที่สุดในชีวิต และวิธีหลุดพ้นจากวงจรเดิมๆ',
    description: 'เรียนรู้บทเรียนสำคัญของการใช้ชีวิต และแนวคิดการพาตัวเองหลุดพ้นจากวงจรเดิมๆ สู่การสร้างอิสรภาพ',
    highlight: 'เปลี่ยนมุมมองชีวิต เพื่อสร้างอนาคตใหม่ที่ไม่ต้องติดอยู่ในวงจรเดิมๆ อีกต่อไป',
  },
  {
    id: 2,
    timeSeconds: 300, // 5:00
    timestamp: '05:00',
    title: 'ความลับของการเปลี่ยนกิจวัตรให้เป็นธุรกิจ (โดยไม่ต้องตื๊อขาย)',
    description: 'แปลงรายจ่ายประจำวัน เช่น แปรงสีฟัน ยาสีฟัน สบู่ แชมพู ให้กลายเป็นธุรกิจสร้างรายได้ยั่งยืนโดยไม่ต้องตื๊อขายใคร',
    highlight: 'เปลี่ยนรายจ่ายในชีวิตประจำวัน ให้กลับมาเป็นรายได้ที่มั่นคงและยั่งยืน',
  },
  {
    id: 3,
    timeSeconds: 420, // 7:00
    timestamp: '07:00',
    title: 'รู้จัก Atomy มหาอำนาจระดับโลกที่มียอดขายหมื่นล้าน/ปี',
    description: 'เปิดเบื้องหลังความยิ่งใหญ่ของ อะโทมี่ บริษัทยักษ์ใหญ่จากเกาหลีใต้ เติบโตสู่ 26+ ประเทศด้วยยอดขายหมื่นล้านบาทต่อปี',
    highlight: 'บริษัทมหาอำนาจระดับโลก เติบโตมั่นคง โปร่งใส และเคารพจิตวิญญาณผู้บริโภค',
  },
  {
    id: 4,
    timeSeconds: 600, // 10:00
    timestamp: '10:00',
    title: 'กลยุทธ์ Masstige สินค้าพรีเมียมที่ทำให้คนซื้อซ้ำ 100%',
    description: 'กลยุทธ์ Absolute Quality, Absolute Price คุณภาพเคาน์เตอร์แบรนด์ในราคาจับต้องได้ จุดแข็งที่ทำให้เกิดการซื้อซ้ำจริงตามธรรมชาติ',
    highlight: 'สินค้าพรีเมียมราคาจับต้องได้ เกิดการซื้อซ้ำจากผู้บริโภคอย่างแท้จริง 100%',
  },
  {
    id: 5,
    timeSeconds: 765, // 12:45
    timestamp: '12:45',
    title: 'แผนรายได้ไร้พรมแดน Global One Market และ Unlimited Depth',
    description: 'โครงสร้างไบนารีระดับโลก รหัสเดียวเชื่อมโยงสายงานได้ทั่วโลก และคำนวณคะแนนยอดขายลึกไม่จำกัดชั้น',
    highlight: 'Global One Server เชื่อมสายงานทั่วโลก ไร้พรมแดน ลึกไม่จำกัดชั้น',
  },
  {
    id: 6,
    timeSeconds: 900, // 15:00
    timestamp: '15:00',
    title: 'ธุรกิจที่ความเสี่ยงเป็นศูนย์ คะแนน PV ไม่มีวันหมดอายุ!',
    description: 'สมัครฟรี 100% ไม่มีค่าแรกเข้า ไม่ต้องสต็อกของ และคะแนนสะสมส่วนตัว (Personal PV) อยู่ถาวรตลอดชีพ ไม่ถูกตัดทิ้ง',
    highlight: 'ความเสี่ยงเป็นศูนย์ ไม่บังคับรักษายอดรายเดือน คะแนน PV คงอยู่ตลอดชีพ',
  },
  {
    id: 7,
    timeSeconds: 1050, // 17:30
    timestamp: '17:30',
    title: 'ก้าวแรกสู่การเริ่มต้น และวิธีรับการเทรนนิ่งฟรี 7 วัน',
    description: 'ขั้นตอนเริ่มต้นลงมือทำจริง การขอรับรหัสสปอนเซอร์ และการเข้าร่วมรับระบบเทรนนิ่งฟรี 7 วันกับทีมงานมืออาชีพ',
    highlight: 'รับรหัสสปอนเซอร์ พร้อมโค้ชพี่เลี้ยง และเข้าระบบเทรนนิ่งฟรี 7 วันทันที',
  },
];
...
export const FAQ_LIST: FaqItem[] = [
  ...
  {
    question: 'ดูวิดีโอ 20 นาทีนี้แล้ว ทำอย่างไรต่อ?',
