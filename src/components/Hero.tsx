        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left max-w-2xl mx-auto lg:max-w-none">
            ...
            <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row items-stretch sm:items-center lg:justify-start gap-3 sm:gap-4">
              ...
              >
                ...
                <span>ดูวิดีโอ 20 นาทีเจาะลึกธุรกิจ</span>
              </button>
              ...
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3 sm:py-3.5 text-sm sm:text-base font-semibold text-white bg-[#06C755] hover:bg-[#05b34c] rounded-xl shadow-md shadow-emerald-500/20 transition-all active:scale-95 min-h-[46px] cursor-pointer"
              >
                <MessageCircle className="w-4 h-4 sm:w-5 sm:h-5 fill-white shrink-0" />
                <span>กรอกฟอร์มรับรหัสฟรี & ทัก LINE</span>
              </button>
            </div>
          ...
          <div className="lg:col-span-5 w-full max-w-lg mx-auto">
            <div className="relative bg-white rounded-2xl p-4 sm:p-7 shadow-xl shadow-slate-200/70 border border-slate-200/90">
              ...
              <div className="mt-3.5 sm:mt-4 p-3 sm:p-3.5 bg-slate-50/90 rounded-xl border border-slate-100 text-xs sm:text-sm text-slate-600 italic leading-relaxed text-pretty">
                "{sponsor.welcomeNote}"
              </div>
              ...
              <div className="mt-4 sm:mt-5 grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-2.5">
                <button
                  type="button"
                  onClick={onOpenLineModal}
                  className="flex items-center justify-center gap-1.5 py-2.5 px-3 bg-[#06C755] hover:bg-[#05b34c] text-white text-xs sm:text-sm font-semibold rounded-lg transition-colors shadow-2xs text-center min-h-[42px] cursor-pointer"
                >
                  <MessageCircle className="w-4 h-4 fill-white shrink-0" />
                  <span>กรอกฟอร์มทัก LINE</span>
                </button>

                {sponsor.phoneNumber ? (
                  <a
                    href={`tel:${sponsor.phoneNumber}`}
                    className="flex items-center justify-center gap-1.5 py-2.5 px-3 bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs sm:text-sm font-semibold rounded-lg transition-colors border border-slate-200 text-center min-h-[42px]"
                  >
              ...
              <div className="mt-3.5 sm:mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
                <span className="flex items-center gap-1.5">
                  <span className="w-2 h-2 rounded-full bg-blue-500 animate-pulse shrink-0" />
                  <span>เว็บพ่วงส่งต่อสายงาน</span>
                </span>
                <button
                  onClick={onOpenLineModal}
                  className="text-blue-600 font-medium hover:underline cursor-pointer flex items-center gap-0.5 shrink-0"
                >
                  ข้อมูลสปอนเซอร์ <ChevronRight className="w-3.5 h-3.5" />
                </button>
              </div>
            </div>
          </div>
