      ...
      <div className="flex items-center justify-between gap-2.5">
        ...
        <div className="flex items-center gap-2 min-w-0 flex-1">
          ...
          <div className="min-w-0">
            <span className="text-[10px] text-slate-400 block truncate leading-tight">สปอนเซอร์:</span>
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          {sponsor.phoneNumber && (
            <a
              ...
              className="p-2 text-slate-700 bg-slate-100 hover:bg-slate-200 rounded-xl transition-colors border border-slate-200 cursor-pointer"
              title="โทรติดต่อ"
            >
